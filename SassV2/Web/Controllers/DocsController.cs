...
namespace SassV2.Web.Controllers
{
	public class DocsController : BaseController
	{
		...
		public bool DocCategory(WebServer server, HttpListenerContext context, string category)
		{
		...
		public bool DocsIndex(WebServer server, HttpListenerContext context)
		{
			return ViewResponse(server, context, "docs/index", new { Title = "Docs", Categories = Categories.Names });
		}
	}
}
