...
namespace SassV2.Commands
{
	public class AnimalCommands
	{
		...
		public async static Task<string> Kitty(DiscordBot bot, Message msg, string args)
		{
		...
		public async static Task<string> Shibe(DiscordBot bot, Message msg, string args)
		{
		...
		public async static Task<string> Bird(DiscordBot bot, Message msg, string args)
		{
